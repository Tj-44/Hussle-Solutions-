    ...
    <div className="font-sans min-h-screen text-gray-900">
      <header className="bg-gradient-to-br from-blue-50 via-white to-gray-100 py-12 px-6 text-center">
        <div className="max-w-5xl mx-auto">
          <img src={logo} alt="Hussle Solutions Logo" className="mx-auto mb-4 w-12 h-12" />
        ...
        <div className="mt-10">
          <img src={hero} alt="Clinic automation" className="rounded-xl shadow-lg mx-auto max-w-3xl" />
        </div>
      </header>
